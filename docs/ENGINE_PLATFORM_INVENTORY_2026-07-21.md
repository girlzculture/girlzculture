...
- API routes: **73**
- Components/modules under `src/components`: **77**
- Ordered SQL migrations: **61**
- Tables/views discovered in migrations: **74**
- Functions discovered in migrations: **82**
- RLS policies discovered in migrations: **160**
...
| `/api/complaints` | GET, POST | `src/app/api/complaints/route.ts` | Provider-neutral AI, disabled fail-closed | Public/customer/salon workflow | Public/owner scope validated per operation | typed/sanitized input, abuse protection | TypeScript/lint/build and route smoke where public |
...
| `/api/i18n` | GET | `src/app/api/i18n/route.ts` | Supabase/database-backed operation | Public/customer/salon workflow | Public/owner scope validated per operation | typed/sanitized input, dependency/confirmation handling | verify:i18n |
...
| `/api/media/upload` | GET, POST, DELETE | `src/app/api/media/upload/route.ts` | Supabase/database-backed operation | Public/customer/salon workflow | Public/owner scope validated per operation | dependency/confirmation handling, server authorization | verify:media |
...
| `/api/salon/records` | POST | `src/app/api/salon/records/route.ts` | Supabase/database-backed operation | Salon dashboard under Engine policy | Salon bearer session plus salon membership/team permission | typed/sanitized input, dependency/confirmation handling, server authorization | verify:records |
...
| `/api/stripe/subscription/change` | POST | `src/app/api/stripe/subscription/change/route.ts` | Stripe/provider-backed financial operation | Stripe provider plus Engine presentation | Public/owner scope validated per operation | typed/sanitized input, server authorization, abuse protection | verify:billing |
...
| `/api/stripe/webhook` | POST | `src/app/api/stripe/webhook/route.ts` | Stripe/provider-backed financial operation | Stripe provider plus Engine presentation | Verified provider signature or server secret | route-specific bounds and safe errors | verify:billing |
...
| --- | --- | --- |
| 1 | `20260710143000_owner_user_id_and_rls.sql` | `supabase/migrations/20260710143000_owner_user_id_and_rls.sql` |
| 2 | `20260710190000_owner_dashboard_suite.sql` | `supabase/migrations/20260710190000_owner_dashboard_suite.sql` |
| 3 | `20260710213000_platform_admin_customer_notifications.sql` | `supabase/migrations/20260710213000_platform_admin_customer_notifications.sql` |
| 4 | `20260711110000_editorial_content_admin_login.sql` | `supabase/migrations/20260711110000_editorial_content_admin_login.sql` |
| 5 | `20260711150000_platform_wiring_fixes.sql` | `supabase/migrations/20260711150000_platform_wiring_fixes.sql` |
| 6 | `20260711190000_subscription_security_scale.sql` | `supabase/migrations/20260711190000_subscription_security_scale.sql` |
| 7 | `20260713110000_critical_blockers.sql` | `supabase/migrations/20260713110000_critical_blockers.sql` |
| 8 | `20260713130000_truthfulness_content_slots.sql` | `supabase/migrations/20260713130000_truthfulness_content_slots.sql` |
| 9 | `20260713180000_booking_integrity.sql` | `supabase/migrations/20260713180000_booking_integrity.sql` |
| 10 | `20260713190000_availability_controls.sql` | `supabase/migrations/20260713190000_availability_controls.sql` |
| 11 | `20260713200000_auto_confirm_cancellation_quality.sql` | `supabase/migrations/20260713200000_auto_confirm_cancellation_quality.sql` |
| 12 | `20260713210000_structured_salon_catalog.sql` | `supabase/migrations/20260713210000_structured_salon_catalog.sql` |
| 13 | `20260713220000_stylist_upload_salon_logo.sql` | `supabase/migrations/20260713220000_stylist_upload_salon_logo.sql` |
| 14 | `20260714100000_auth_mfa_security.sql` | `supabase/migrations/20260714100000_auth_mfa_security.sql` |
| 15 | `20260714110000_team_permissions.sql` | `supabase/migrations/20260714110000_team_permissions.sql` |
| 16 | `20260714120000_admin_booking_operations.sql` | `supabase/migrations/20260714120000_admin_booking_operations.sql` |
| 17 | `20260714130000_salon_open_status.sql` | `supabase/migrations/20260714130000_salon_open_status.sql` |
| 18 | `20260714140000_structured_salon_addresses.sql` | `supabase/migrations/20260714140000_structured_salon_addresses.sql` |
| 19 | `20260714150000_team_permission_hardening.sql` | `supabase/migrations/20260714150000_team_permission_hardening.sql` |
| 20 | `20260714160000_team_subscription_inheritance.sql` | `supabase/migrations/20260714160000_team_subscription_inheritance.sql` |
| 21 | `20260714170000_web_push.sql` | `supabase/migrations/20260714170000_web_push.sql` |
| 22 | `20260714180000_verified_complaints.sql` | `supabase/migrations/20260714180000_verified_complaints.sql` |
| 23 | `20260714190000_booking_messages.sql` | `supabase/migrations/20260714190000_booking_messages.sql` |
| 24 | `20260714200000_homepage_trending_video.sql` | `supabase/migrations/20260714200000_homepage_trending_video.sql` |
| 25 | `20260714210000_promo_codes.sql` | `supabase/migrations/20260714210000_promo_codes.sql` |
| 26 | `20260714220000_application_onboarding.sql` | `supabase/migrations/20260714220000_application_onboarding.sql` |
| 27 | `20260714230000_guided_onboarding.sql` | `supabase/migrations/20260714230000_guided_onboarding.sql` |
| 28 | `20260714240000_mobile_content.sql` | `supabase/migrations/20260714240000_mobile_content.sql` |
| 29 | `20260714250000_generic_service_catalog.sql` | `supabase/migrations/20260714250000_generic_service_catalog.sql` |
| 30 | `20260715100000_content_management_sections.sql` | `supabase/migrations/20260715100000_content_management_sections.sql` |
| 31 | `20260715110000_legal_content_pages.sql` | `supabase/migrations/20260715110000_legal_content_pages.sql` |
| 32 | `20260715120000_admin_inbox_unread.sql` | `supabase/migrations/20260715120000_admin_inbox_unread.sql` |
| 33 | `20260715130000_subscription_stylist_booking_fixes.sql` | `supabase/migrations/20260715130000_subscription_stylist_booking_fixes.sql` |
| 34 | `20260715140000_admin_service_catalog.sql` | `supabase/migrations/20260715140000_admin_service_catalog.sql` |
| 35 | `20260715150000_numeric_input_bounds.sql` | `supabase/migrations/20260715150000_numeric_input_bounds.sql` |
| 36 | `20260715160000_discoverability_setup_gate.sql` | `supabase/migrations/20260715160000_discoverability_setup_gate.sql` |
| 37 | `20260715170000_legal_page_visibility.sql` | `supabase/migrations/20260715170000_legal_page_visibility.sql` |
| 38 | `20260715180000_subscription_lifecycle.sql` | `supabase/migrations/20260715180000_subscription_lifecycle.sql` |
| 39 | `20260715190000_billing_event_ledger.sql` | `supabase/migrations/20260715190000_billing_event_ledger.sql` |
| 40 | `20260715200000_storage_policy_qualification.sql` | `supabase/migrations/20260715200000_storage_policy_qualification.sql` |
| 41 | `20260716120000_location_foundation.sql` | `supabase/migrations/20260716120000_location_foundation.sql` |
| 42 | `20260716130000_organic_salon_discovery.sql` | `supabase/migrations/20260716130000_organic_salon_discovery.sql` |
| 43 | `20260716140000_admin_salon_operations.sql` | `supabase/migrations/20260716140000_admin_salon_operations.sql` |
| 44 | `20260716150000_featured_salon_campaigns.sql` | `supabase/migrations/20260716150000_featured_salon_campaigns.sql` |
| 45 | `20260716160000_trending_video_campaigns.sql` | `supabase/migrations/20260716160000_trending_video_campaigns.sql` |
| 46 | `20260716170000_marketplace_security_hardening.sql` | `supabase/migrations/20260716170000_marketplace_security_hardening.sql` |
| 47 | `20260720100000_canonical_identity.sql` | `supabase/migrations/20260720100000_canonical_identity.sql` |
| 48 | `20260720110000_admin_identity_security.sql` | `supabase/migrations/20260720110000_admin_identity_security.sql` |
| 49 | `20260720120000_admin_salon_result_integrity.sql` | `supabase/migrations/20260720120000_admin_salon_result_integrity.sql` |
| 50 | `20260720130000_salon_lifecycle_engine.sql` | `supabase/migrations/20260720130000_salon_lifecycle_engine.sql` |
| 51 | `20260720140000_search_language_engine.sql` | `supabase/migrations/20260720140000_search_language_engine.sql` |
| 52 | `20260720150000_unified_media_engine.sql` | `supabase/migrations/20260720150000_unified_media_engine.sql` |
| 53 | `20260720160000_localization_engine.sql` | `supabase/migrations/20260720160000_localization_engine.sql` |
| 54 | `20260720170000_platform_engine_governance.sql` | `supabase/migrations/20260720170000_platform_engine_governance.sql` |
| 55 | `20260720180000_record_lifecycle_management.sql` | `supabase/migrations/20260720180000_record_lifecycle_management.sql` |
| 56 | `20260720190000_identity_deletion_and_reuse.sql` | `supabase/migrations/20260720190000_identity_deletion_and_reuse.sql` |
| 57 | `20260720200000_safe_test_data_batches.sql` | `supabase/migrations/20260720200000_safe_test_data_batches.sql` |
| 58 | `20260720210000_platform_engine_governance_recovery.sql` | `supabase/migrations/20260720210000_platform_engine_governance_recovery.sql` |
| 59 | `20260720220000_booking_reminder_delivery.sql` | `supabase/migrations/20260720220000_booking_reminder_delivery.sql` |
| 60 | `20260720230000_trending_video_posters.sql` | `supabase/migrations/20260720230000_trending_video_posters.sql` |
| 61 | `20260721100000_engine_localization_ai_system.sql` | `supabase/migrations/20260721100000_engine_localization_ai_system.sql` |
