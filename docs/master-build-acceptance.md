...
- Master Build changes: local implementation checkpoints from `c461a6c` through `df7e6ff`, plus reviewed stock, photo, client-card and review-reply actions; not yet pushed or released. No Master Build migration, application change or demo record has been applied to production.
