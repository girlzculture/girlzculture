...
const checks = [
  ...
  ["public selector removed", `${read("src/components/site/PublicChrome.tsx")}\n${read("src/components/site/MobilePublicMenu.tsx")}`, /^(?![\s\S]*<LanguageSelector)[\s\S]*$/],
  ["internal selector retained", read("src/components/AdminDashboard.tsx"), /<LanguageSelector/],
  ["selector limited to managed localization", read("src/components/i18n/LanguageSelector.tsx"), /if \(!managedLocalization\) return null/],
  ["public DOM excluded from localization bridge", read("src/components/i18n/DocumentLocalizationBridge.tsx"), /if \(!managedLocalization\) return/],
