...
for(const token of ["text_direction","translation_entry_versions","ai_automation_features","ai_prompt_versions","ai_generation_drafts","ai_usage_events","engine_system_components","navigation_items"])if(!migration.includes(token))failures.push(`Migration missing ${token}`);
