...
for (const pattern of [/admin_save_featured_campaign_v2/,/admin_manage_featured_campaign/,/indefinite/,/revalidatePath\("\/"\)/,/mode\) === "salons"/]) assert.match(featuredApi, pattern);
