...
assert.equal(
  deterministicConciergeIntent("I want to braid my hair", "en").style,
  "Braids",
);
...
assert.match(uiSource, /Here are the matches I found\./);
assert.match(uiSource, /AI not configured/);
assert.match(managerSource, /Not Configured/);
