...
function fixture(options={}) {
 ...
 const finance={scope,sales:[],bookings:[row],receipts:options.receipts||[],expenses:[],arrangements:[],obligations:[],compensation_payments:[],stylists:[]};
...
test('186 preserves every prior audit tool and adds only the two risk-1 money reads',()=>{
 ...
 const core=fixture().loader('src/lib/gcAssistantCore.ts');assert.deepEqual(new Set(names(current)),new Set(Object.keys(core.ASSISTANT_TOOLS)));
