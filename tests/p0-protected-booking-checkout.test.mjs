...
function fixture({offer=true,value=20,rate=10,threshold=null}={}){
 ...
 return {stripe,reservations,events,bookings,body,post:patch=>route.POST(new Request('https://fixture.invalid/api/stripe/booking-checkout',{method:'POST',body:JSON.stringify({...body,...patch})}))};
}
