...
export default function WorkspaceToolbar({ homeHref, homeLabel, current, destinations }: {
  ...
  return <div className="gc-workspace-toolbar">
    <nav aria-label="Workspace breadcrumbs" className="flex min-w-0 items-center gap-2 text-sm">
