...
function Quality(p: any) {
  ...
  const metrics=p.salons.map((salon:Row)=>{
    ...
    return {...salon,totalBookings:bookings.length,salonCancellations,cancellationRate,onTimeRate,activeComplaints,qualityScore:weight?weighted/weight:null,flagged:cancellationRate>effectiveThreshold};
  });
