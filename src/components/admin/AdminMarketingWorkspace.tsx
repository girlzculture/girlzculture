...
const workspaces = [
  { id: "featured", label: "Featured Business campaigns", description: "Schedule paid and eligible business placements without opening other campaign editors.", icon: BadgeDollarSign },
...
export default function AdminMarketingWorkspace({ overview }: { overview?: React.ReactNode }) {
  return <div data-admin-record-landing className="space-y-5">
    <AdminMarketWorkspaces scope="marketing"/>
