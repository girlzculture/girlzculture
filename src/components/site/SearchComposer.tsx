...
export default function SearchComposer({ compact = false }: { compact?: boolean }) {
  ...
  return <form onSubmit={submit} className={`relative z-[70] overflow-visible border border-plum/10 bg-[#fffdfa] shadow-[0_12px_34px_rgba(26,18,32,.10)] ${compact ? "rounded-[14px] p-2.5" : "rounded-[16px] p-2.5 sm:p-3 md:p-1.5"}`}>
