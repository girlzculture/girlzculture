...
export default function CustomerAuth() {
  ...
  return <div>
    ...
    <form onSubmit={submit} className="space-y-5 p-6 sm:p-8">
      ...
      <button disabled={loading || Boolean(challenge && code.length !== 6)} className="w-full rounded-[9px] bg-magenta py-3.5 font-bold text-white gc-disabled-control">{loading ? "Please wait..." : mode === "login" ? challenge ? "Verify and log in" : "Log in" : "Sign up"}</button>
