...
export const ENGLISH_MESSAGES: Record<string,string> = {
  ...
  "notification.booking.customer_confirmed.body":"Your appointment is confirmed.\n\n{{summary}}\n\nBooking reference: {{confirmation_code}}\n\nView your booking: {{account_url}}",
  "notification.booking.salon_confirmed.subject":"New confirmed Girlz Culture booking",
  "notification.booking.salon_confirmed.body":"A new booking is confirmed.\n\n{{summary}}\n\nOpen this booking: {{dashboard_url}}",
  "notification.booking.stylist_confirmed.subject":"A Girlz Culture booking was assigned to you",
  "notification.booking.stylist_confirmed.body":"A booking was assigned to you.\n\n{{summary}}\n\nOpen your appointment: {{dashboard_url}}",
  "notification.booking.customer_cancelled.subject":"Your Girlz Culture appointment was cancelled",
  "notification.booking.customer_cancelled.body":"Your appointment was cancelled.\n\n{{message}}\n\nWe are sorry for the disruption. Find another available salon: {{browse_url}}",
  "notification.booking.salon_cancelled.subject":"Girlz Culture booking cancelled",
  "notification.booking.salon_cancelled.body":"A booking was cancelled.\n\n{{message}}",
  "notification.booking.stylist_cancelled.subject":"An assigned Girlz Culture booking was cancelled",
  "notification.booking.stylist_cancelled.body":"An assigned booking was cancelled.\n\n{{message}}",
  "notification.booking.customer_reminder.subject":"Your Girlz Culture appointment is coming up",
  "notification.booking.customer_reminder.body":"Appointment reminder.\n\n{{summary}}\n\nView your booking: {{account_url}}",
  "notification.booking.salon_reminder.subject":"Upcoming Girlz Culture appointment",
  "notification.booking.salon_reminder.body":"Appointment reminder.\n\n{{summary}}\n\nOpen booking: {{dashboard_url}}",
  "notification.booking.stylist_reminder.subject":"Upcoming assigned appointment",
  "notification.booking.stylist_reminder.body":"Appointment reminder.\n\n{{summary}}",
  "notification.booking.customer_confirmed.summary":"{{service}} at {{salon}} is confirmed for {{when}}. Stylist: {{professional}}.",
  "notification.booking.salon_confirmed.summary":"{{customer}} booked {{service}} for {{when}}. Duration: {{duration}}. Stylist: {{professional}}.",
  "notification.booking.customer_cancelled.summary":"Your {{service}} appointment at {{salon}} for {{when}}{{stylist_clause}} was cancelled. Reason: {{reason}}. {{refund_message}}",
  "notification.booking.salon_cancelled.summary":"{{customer}}'s {{service}} appointment for {{when}}{{stylist_clause}} was cancelled. Reason: {{reason}}.",
  "notification.booking.customer_reminder.summary":"Reminder: {{service}} at {{salon}} is scheduled for {{when}}{{stylist_clause}}.",
  "notification.booking.salon_reminder.summary":"Reminder: {{customer}}'s {{service}} appointment is scheduled for {{when}}{{stylist_clause}}.",
  "notification.booking.refund.succeeded":"Your {{refund_amount}} reservation deposit was refunded in full.",
  "notification.booking.refund.none":"No deposit refund was due for this booking.",
  "notification.booking.customer_confirmed.sms":"Girlz Culture: {{summary}} Reference {{confirmation_code}}. {{account_url}}",
  "notification.booking.salon_confirmed.sms":"Girlz Culture confirmed booking: {{summary}} {{dashboard_url}}",
  "notification.booking.stylist_confirmed.sms":"Girlz Culture assigned booking: {{summary}} {{dashboard_url}}",
  "notification.booking.customer_cancelled.sms":"Girlz Culture: {{message}}",
  "notification.booking.salon_cancelled.sms":"Girlz Culture: {{message}}",
  "notification.booking.customer_reminder.sms":"Girlz Culture: {{summary}}",
  "notification.booking.salon_reminder.sms":"Girlz Culture: {{summary}}",
  "notification.booking.customer_confirmed.push_title":"Appointment confirmed",
  "notification.booking.salon_confirmed.push_title":"New confirmed booking",
  "notification.booking.stylist_confirmed.push_title":"A booking was assigned to you",
  "notification.booking.customer_cancelled.push_title":"Appointment cancelled",
  "notification.booking.salon_cancelled.push_title":"Booking cancelled",
  "notification.booking.stylist_cancelled.push_title":"Assigned booking cancelled",
  "notification.booking.customer_reminder.push_title":"Appointment reminder",
  "notification.booking.salon_reminder.push_title":"Upcoming appointment",
  "notification.booking.stylist_reminder.push_title":"Upcoming assigned appointment",
};
