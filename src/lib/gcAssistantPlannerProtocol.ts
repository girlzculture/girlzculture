...
const purposes: Record<AssistantTool, string> = {
  ...
  prepare_service_change: "Read services. Patch name,description,master_style_id,base_price,price_display_min/max,duration_min/max_hours,buffer_minutes,is_draft,is_featured. Null ID=create: exact catalog name/ID,price,both durations required. is_draft=false publishes only on request. Other prices/options unchanged.",
