...
const purposes: Record<AssistantTool, string> = {
  ...
  prepare_photo_change: "Read get_business_media (upload picker). photo_details:{url,category,title,caption,featured,source_locale}; photo_add/cover/remove:{url}. category services|before_after|space|team|client_love|other. Own URL; add requires finalized upload; record_id=null. Remove=unlink.",
  ...
  prepare_review_reply: "Read get_reviews; own UUID; review_reply changes_json={reply}. Owner-approved wording; review/confirm before publishing.",
