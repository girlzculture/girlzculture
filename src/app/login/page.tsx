...
export default function CustomerLogin() {
  ...
  return <main className="min-h-screen bg-cream p-4 text-ink">
    <header className="mx-auto flex max-w-[1500px] flex-wrap items-center justify-between gap-x-4 gap-y-3 py-4"><Wordmark/><div data-language-selector-host className="flex items-center gap-5"><nav className="hidden gap-8 text-sm font-semibold md:flex"><Link href="/salons">Find Salons</Link><Link href="/styles">Services</Link><Link href="/partner">For Stylists</Link><Link href="/how-it-works">How It Works</Link></nav><LanguageSelector compact/></div></header>
