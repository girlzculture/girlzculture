...
export default function ApplyPage() {
  ...
  return <main className="min-h-screen bg-cream text-ink">
    ...
    <div className="mx-auto grid w-full max-w-[1540px] gap-0 px-4 py-8 lg:grid-cols-[390px_1fr] lg:px-10">
      ...
      <div className="lg:-ml-px"><Suspense fallback={<div className="rounded-[18px] bg-white p-10 text-center text-plum">Loading application…</div>}><SalonApplication/></Suspense></div>
    </div>
  </main>;
}
