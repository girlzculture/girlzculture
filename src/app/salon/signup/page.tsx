...
export default function SignupPage() {
  return <main className="min-h-screen bg-cream p-4 text-ink sm:p-6"><div className="mx-auto grid min-h-[calc(100vh-3rem)] max-w-[1500px] overflow-hidden rounded-[22px] border border-plum/10 bg-white shadow-[0_20px_70px_rgba(13,17,20,.09)] lg:grid-cols-[.95fr_1fr]">
