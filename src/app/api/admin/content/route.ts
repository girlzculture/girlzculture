...
export async function GET(request: Request) {
  try {
    ...
    const [pages, posts, masterStyles, serviceCategories, salons, products] = await Promise.all([
    ...
    return Response.json({ pages: pages.data || [], posts: posts.data || [], masterStyles: masterStyles.data || [], serviceCategories: serviceCategories.data || [], linkTargets });
  } catch (error) {
