...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      grep: /Business inventory|Business products|Service assignments|Public service assignments|Business team|Business catalog|Private client record|client field restrictions|Deposit rules|Attendance change|Published offer preserves|Business finance|front desk logging|Dashboard redesign|P0 customer account|P0 customer support|homepage shell has no overflow|promotion rail respects reduced motion|business cards open the correct flow directly|P0 owner core language flow|P0 policy publication|P0 owner route inventory|P0 populated owner|P0 booking composer|P0 original service|P0 Assistant launcher|P0 Assistant all skills|P0 Assistant spoken controls|P0 Assistant memory|P0 Assistant submission|P0 Assistant workspace|P0 Assistant respects|P0 account locale|P0 booking recipient|P0 public policy|P0 operational calendar/,
